...
<head>
    ...
    <link rel="stylesheet" href="../public/css/deposito.css">
    <title>Caixa Eletrônico - Depositar</title>
</head>
<body>
    <div class="deposito-container">
        <h2>Depositar</h2>
        <form action="?acao=depositar" method="POST">
            <div class="valor-total">
                <label for="valorTotal">Valor do depósito:</label>
                <input type="text" name="valorTotal" placeholder="R$" class="campo" required readonly>
            </div>
            ...
            <div class="botoes-container">
                <button type="submit" class="botoes">Depositar</button>
    ...
    <script src="../public/js/deposito.js"></script>
</body>
</html>